...
componentes de la interfaz. Ese documento también explica cómo el MVP aproxima el **bucle
introspectivo proactivo** del documento maestro mediante A2A, controles de propósito y ajustes
neurohormonales.
